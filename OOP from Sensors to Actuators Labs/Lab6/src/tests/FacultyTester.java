...
public class FacultyTester {
	...
	System.out.println("f1 and f3");
	// Q2: Do f1 and f3 have the same contents (attributes values)? 
	 ...
	 * Using any of the names (f1 and f4) as the context object for a mutator method call
