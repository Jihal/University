...
public class CourseRecordTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(cr1.getDescription()); // what's the value if cr1.instructor?
		...
		System.out.print("cr1 and cr2 have the same instructor: " + (cr1.getInstructor()) == cr2.getDescription());
		System.out.print("cr2 and cr3 have the same instructor: " + (cr2.getInstructor()) == cr3.getDescription());
		System.out.print("cr1 and cr3 have the same instructor: " + (cr1.getInstructor()) == cr3.getDescription());
