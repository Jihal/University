...
public class Card implements Comparable<Card> {
	...
	public int compareTo(Card other) {
		if (rank.compareTo(this.rank) < rank.compareTo(other.rank)) {
			return 1;
		} else if (rank.compareTo(this.rank) > rank.compareTo(other.rank)) {
			return -1;
		} else {
			if (suit.compareTo(this.suit) < suit.compareTo(other.suit)) {
				return 1;
			} else if (suit.compareTo(this.suit) > suit.compareTo(other.suit)) {
				return -1;
			} else {
				return 0;
			}
